...
class ListaTerremotos1HTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        terremotos = ["Katrina","cmap","Volkswagen"]
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "terremotos", for: indexPath)// as! ListaTerremotos1HTableViewController
            ...
            .responseData { response in
                if let data = response.data {
                    ...
                    for terremoto in xml["q:quakeml","eventParameters","event"] {
                        ...
                        // Configure the cell...
                        cell.textLabel?.text = (terremoto["description","text"].text)
                        //cell.Celda.text=terremotos[indexPath.row]
